...
namespace MotaMarket.Services
{
    public static class ApiService
    {
        public static async Task<bool> RegisterUser(string name, string email, string password)
        {
            ...
            var response = await httpClient.PostAsync("https://motamarket.azurewebsites.net/api/accounts/register", content);
        ...
        public static async Task<bool> Login(string email, string password)
        {
            ...
            var content = new StringContent(json, Encoding.UTF8, "application/json");
            var response = await httpClient.PostAsync("https://motamarket.azurewebsites.net/api/accounts/login", content);
            if (!response.IsSuccessStatusCode) return false;
        ...
        public static async Task<bool> ChangePassword(string oldPassword, string newPassword, string confirmPassword)
        {
            ...
            var response = await httpClient.PostAsync("https://motamarket.azurewebsites.net/api/accounts/ChangePassword", content);
            if (!response.IsSuccessStatusCode) return false;
            return true;
        }
        ...
        public static async Task<bool> EditPhoneNumber(string phoneNumber)
        {
            ...
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accessToken", string.Empty));
            var response = await httpClient.PostAsync("https://motamarket.azurewebsites.net/api/accounts/EditPhoneNumber", content);
            if (!response.IsSuccessStatusCode) return false;
            return true;
        }
        ...
        public static async Task<bool> EditUserProfile(byte[] imageArray)
        {
            ...
            var content = new StringContent(json, Encoding.UTF8, "application/json");
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accessToken", string.Empty));
            var response = await httpClient.PostAsync("https://motamarket.azurewebsites.net/api/accounts/EditUserProfile", content);
            if (!response.IsSuccessStatusCode) return false;
            return true;
        }
        ...
        public static async Task<UserImageModel> GetUserProfileImage()
        {
            ...
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accessToken", string.Empty));
            var response = await httpClient.GetStringAsync("https://motamarket.azurewebsites.net/api/accounts/UserProfileImage");
        ...
        public static async Task<List<Category>> GetCategories()
        {
            ...
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accessToken", string.Empty));
            var response = await httpClient.GetStringAsync("https://motamarket.azurewebsites.net/api/Categories");
        ...
        public static async Task<bool> AddImage(int vehicleId, byte[] imageArray)
        {
            ...
            var content = new StringContent(json, Encoding.UTF8, "application/json");
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accessToken", string.Empty));
            var response = await httpClient.PostAsync("https://motamarket.azurewebsites.net/api/Images", content);
            if (!response.IsSuccessStatusCode) return false;
            return true;
        }
        ...
        public static async Task<VehicleDetail> GetVehicleDetail(int id)
        {
            ...
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accessToken", string.Empty));
            var response = await httpClient.GetStringAsync($"https://motamarket.azurewebsites.net/api/Vehicles/VehicleDetails?id={id}");
        ...
        public static async Task<List<VehicleByCategory>> GetVehicleByCategory(int categoryId)
        {
            ...
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accessToken", string.Empty));
            var response = await httpClient.GetStringAsync($"https://motamarket.azurewebsites.net/api/Vehicles?categoryId={categoryId}");
        ...
        public static async Task<List<SearchVehicle>> SearchVehicle(string search)
        {
            ...
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accessToken", string.Empty));
            var response = await httpClient.GetStringAsync($"https://motamarket.azurewebsites.net/api/Vehicles/SearchVehicles?search={search}");
        ...
        public static async Task<VehicleResponse> AddVehicle(Vehicle vehicle)
        {
            ...
            var content = new StringContent(json, Encoding.UTF8, "application/json");
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accessToken", string.Empty));
            var response = await httpClient.PostAsync("https://motamarket.azurewebsites.net/api/Vehicles", content);
            var jsonResult = await response.Content.ReadAsStringAsync();
        ...
        public static async Task<List<HotAndNewAd>> GetHotAndNewAds()
        {
            ...
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accessToken", string.Empty));
            var response = await httpClient.GetStringAsync("https://motamarket.azurewebsites.net/api/Vehicles/HotAndNewAds");
        ...
        public static async Task<List<MyAd>> GetMyAds()
        {
            ...
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accessToken", string.Empty));
            var response = await httpClient.GetStringAsync("https://motamarket.azurewebsites.net/api/Vehicles/MyAds");
